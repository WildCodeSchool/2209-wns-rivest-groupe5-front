    ...
    <>
        ...
        >
          ...
          >
            ...
            <Box>
              ...
              <Typography>
                ...
                pour faciliter la transition vers un mode de vie plus durable et
          ...
          >
            ...
            <Box>
              ...
              <Typography>
                WildCarbon est <strong>un projet gratuit</strong>, accessible à
                tous ceux qui souhaitent s'engager en faveur de l'écologie et du
                développement durable. Toutefois, si vous trouvez l'application
                utile et souhaitez soutenir son développement, il est possible
                de contribuer en <strong>faisant un don</strong>.
              </Typography>
            </Box>
          </Box>
          ...
          >
            ...
            <Box>
              ...
              <Typography>
                ...
                <strong>communauté WildCarbon</strong> et participez activement
                à la construction d'un avenir plus vert et durable pour tous.
                Ensemble, nous pouvons faire la différence et{' '}
                <strong>préserver notre planète</strong> pour les générations
                futures.
              </Typography>
            </Box>
          </Box>
      ...
      >
        ...
        >
          ...
          >
            Vous accompagner dans une transition écologique
          </Typography>
        </Box>
        <Box
          sx={{
        ...
        >
          ...
          />
          <HomePageCard
            title="Partager vos astuces éco"
            content="La communeauté partage régulièrement des astuces pour réduire ses émissions de gaz à effet de serre"
            image={carbonNeutral}
          />
          <HomePageCard
      ...
      >
        ...
        >
          ...
          <Typography sx={{ mt: 1, paddingLeft: '30px', width: '50%' }}>
            Afin de soutenir le développement de l'application, nous avons mis
            en place une cagnotte en ligne. Si vous souhaitez nous soutenir,
            vous pouvez{' '}
            <a
      ...
      >
        ...
        >
          ...
          >
            Partagez vous aussi vos astuces bas carbone !
          </Typography>
        </Box>
