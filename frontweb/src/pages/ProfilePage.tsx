...
const ProfilePage = () => {
    ...
    if (
        ...
        if (
            ...
            return (
                <div>
                    Cet utilisateur est privé. Vous ne pourrez accéder à ses
                    informations qu'en vous abonnant à son compte lorsqu'il aura
                    passé son profil en public.
                </div>
            );
        }

        return (
            <div>Une erreur inattendue est survenue... Veuillez réessayer.</div>
        );
    }
                ...
                <Grid container spacing={3}>
                    ...
                    <Grid item xs={12}>
                        ...
                        >
                            <ActivityList
                                data={
                                    activitiesData?.getPublicOrFollowedUserLastSevenDaysActivities
                                }
